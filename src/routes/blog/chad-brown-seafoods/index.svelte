    ...
    <div class="mx-auto max-w-prose text-lg">
      <h1>
        ...
        <span
          ...
          >GSE Welcomes Chad Brown Seafoods</span
        >
      </h1>
      <p class="mt-8 text-xl leading-8 text-gse-pacificGrey">
        We're proud to welcome Chad Brown Seafoods to GSE Live! Chad Brown
        Seafoods specializes in live Atlantic lobster, soft shell clams,
        scallops, and haddock. If you're looking for wholesale seafood from one
        of New Brunswick's finest seafood processors, check out his GSE Live
        Seafood Store page.<br /><br />
      </p>
    </div>
    <div class="prose prose-lg prose-indigo mx-auto mt-6 text-gse-pacificGrey">
      ...
      <figure>
        <img
          ...
          src="/ChadBrownSeafoodsCover.jpg"
          alt=""
          width="1310"
          height="873"
        />
        <figcaption>Chad Brown Seafoods</figcaption>
      </figure>
