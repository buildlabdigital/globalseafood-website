    ...
    <div class="mx-auto max-w-prose text-lg">
      <h1>
        ...
        <span
          ...
          >North American Seafood Expo 2022</span
        >
      </h1>
      <p class="mt-8 text-xl leading-8 text-gse-pacificGrey">
        It was our first time to the North American Seafood Expo and it was a
        great learning experience. We met with a large number of processors and
        wholesalers to learn more about their businesses and how we may help
        them. The overall feedback was very positive. Many people said they've
        been waiting for a platform just like this. <br /> <br />We've set up a
        number of meetings to demo GSE Live to help learn more about the needs
        of processors and wholesalers. The feedback will be a big help in
        determining the final build before release. <br /><br />
      </p>
    </div>
    <div class="prose prose-lg prose-indigo mx-auto mt-6 text-gse-pacificGrey">
      ...
      <figure>
        <img
          ...
          src="/NaSeafood2022Cover.jpg"
          alt=""
          width="1310"
          height="873"
        />
        <figcaption>North American Seafood Expo 2022</figcaption>
      </figure>
