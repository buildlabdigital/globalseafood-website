<!--
  ...
  ```
-->
<div class="relative overflow-hidden bg-gse-pacificBlue py-16">
  <div
  ...
  <div class="relative px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-prose text-lg">
      <h1>
        ...
        <span
          ...
          >GSE Live Web Beta Released</span
        >
      </h1>
      <p class="mt-8 text-xl leading-8 text-gse-pacificGrey">
        We've officially launched our GSE Live web app to make buying and
        selling seafood B2B easier. This gives B2B seafood companies the ability
        to have their own landing page to sell their products. You also receive
        direct product links you can use on your own site to show case your
        seafood.<br /> <br />The software allows you to create buy and sell
        listings, receive orders and offers, pre-order seafood for a future
        date, use one of 38 currencies to meet the needs of your business, and
        export all orders for year end book keeping and inventory management.
        There are many more features we'd love to share with anyone looking to
        join us in changing the way the world buys and sells seafood B2B. Feel
        free to reach out to book a demo.<br /><br />A bit of our start-up story
        to day. It's been nearly two years of development with roughly 70,000
        lines of code to create the web and upcoming iOS apps. We're thrilled to
        see where this journey takes us. Stay tuned for more. <br /> <br />
      </p>
    </div>
    <div class="prose prose-lg prose-indigo mx-auto mt-6 text-gse-pacificGrey">
      <!-- <p>
          ...
          >
          sed
          <strong class="text-gse-pacificGrey">eget risus enim</strong>. Mattis
          mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est.
        ...
        <h2 class="text-white">From beginner to expert in 30 days</h2>
        <p>
        ...
        <blockquote class="text-gse-pacificGrey">
          <p>
      ...
      <figure>
        <img
          ...
          src="/gseLiveWebCover.jpg"
          alt=""
          width="1310"
          height="873"
        />
        <figcaption>GSE Live Web</figcaption>
      </figure>
