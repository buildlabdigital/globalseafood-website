...
<div class="overflow-hidden bg-gse-pacificBlue">
    ...
    <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
      ...
      >
        <div>
          <dt>
            <div
              class="flex h-12 w-12 items-center justify-center rounded-md bg-gse-pacificBlueMessage text-white"
            >
          ...
          <dd class="mt-2 text-base text-gse-pacificGrey">
